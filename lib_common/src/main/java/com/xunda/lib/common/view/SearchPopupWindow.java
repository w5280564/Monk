...
public class SearchPopupWindow{
    ...
    public SearchPopupWindow(Builder builder) {
...
//        mPopupWindow.setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_VISIBLE);
        ...
        mPopupWindow.setInputMethodMode(PopupWindow.INPUT_METHOD_NEEDED);
        mPopupWindow.setFocusable(true);// 聚焦点击事件不会透传给下面的View
...
//        mPopupWindow.setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);
     ...
     * @return
     */
    public SearchPopupWindow showAtLocation(View view, int gravity, int x, int y) {
     ...
     * @return
     */
    public SearchPopupWindow showAsDropDown(View anchor, int xOff, int yOff) {
        if (mPopupWindow != null) {
    ...
    public static class Builder {
        ...
        public SearchPopupWindow build() {
            return new SearchPopupWindow(this);
        }
    }
