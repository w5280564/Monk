...
public class WheelView extends View {
	...
	/** Top and bottom shadows colors */
	private static int[] SHADOWS_COLORS = new int[] { 0xFFFFFFFF,
	...
	private int wheelForeground = R.color.text_color_EEEEEE;
	...
	// The number of first item_choose_image in layout
		...
		public void onFinished() {
			...
			if(changingListeners!=null){
				for (OnWheelChangedListener listener : changingListeners) {
					listener.onStopChanged(WheelView.this, currentItem);
				}
			}
	 ...
	 * @param oldValue the old wheel values
	 * @param newValue the new wheel values
	 */
	...
	/**
	 * Sets the current item_choose_image. Does nothing when index is wrong.
	 *
	...
	/**
	 * Sets the current item_choose_image w/o animation. Does nothing when index is wrong.
	 *
	 * @param index the item_choose_image index
	 */
	...
	/**
	 * Tests if wheel is cyclic. That means before the 1st item_choose_image there is shown the last one
	...
	/**
	 * Returns height of wheel item_choose_image
	 * @return the item_choose_image height
	 */
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		int height = itemsLayout.getMeasuredWidth();
...
//		canvas.drawRect(0,center - offset,getWidth(),getHeight(),paint);
	...
	/**
	 * Scrolls the wheel
	 * @param delta the scrolling values
	 */
	...
	/**
	 * Creates item_choose_image layouts if necessary
	 */
	...
	/**
	 * Adds view for item_choose_image to items layout
	 * @param index the item_choose_image index
	 * @param first the flag indicates if view should be first
	 * @return true if corresponding item_choose_image exists and is added
	 */
	 ...
	 * @param index the item_choose_image index
	 * @return true if item_choose_image index is not out of bounds or the wheel is cyclic
	 */
	...
	/**
	 * Returns view for specified item_choose_image
	 * @param index the item_choose_image index
	 * @return item_choose_image view or empty view if index is out of bounds
	 */
