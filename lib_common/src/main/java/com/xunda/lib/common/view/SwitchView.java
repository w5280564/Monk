 ...
 * ================================================
 *
 * @Description: switch控件
 * @Author: Zhangliangliang
 * @CreateDate: 2021/8/14 22:01
 * ================================================
 */
public class SwitchView  extends View {
    ...
    public SwitchView(Context context, AttributeSet attrs) {
        ...
        colorBar = a.getColor(R.styleable.SwitchView_bar_color, 0xFFFFFFFF);
        colorBackground = a.getColor(R.styleable.SwitchView_Sv_bgColor, 0xFFFFFFFF);
