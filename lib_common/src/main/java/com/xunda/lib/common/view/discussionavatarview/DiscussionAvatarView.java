package com.xunda.lib.common.view.discussionavatarview;
...
public class DiscussionAvatarView extends ViewGroup {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        if (array != null) {
            ...
            mRadius = DisplayUtil.dip2px(context, radius);
    ...
    public void initDatas(ArrayList<String> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (mIsLastComplete) {
                GlideUtils.loadCircleImage(mContext, iv, list.get(i),mFrameColor);
            } else {
                GlideUtils.loadCircleImage(mContext, iv,  list.get(size - i - 1), mFrameColor);
            }
            this.addView(iv);
        }
    }
    ...
    public void addData(String ava, DiscussionAvatarListener listener1) {
        ...
        GlideUtils.loadCircleImage(mContext, iv, ava,mFrameColor);
        if (mIsLastComplete) {
            this.addView(iv);
        } else {
            this.addView(iv, 0);
