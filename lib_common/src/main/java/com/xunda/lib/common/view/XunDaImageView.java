 ...
 */
public class XunDaImageView extends AppCompatImageView {
    ...
    public XunDaImageView(Context context) {
        super(context);
        init(context, null);
    }

    public XunDaImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public XunDaImageView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // get attribute of XunDaImageView
        if (attrs != null) {
            TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.XunDaImageView);
            borderColor = array.getColor(R.styleable.XunDaImageView_xunda_border_color, borderColor);
            borderWidth = array.getDimensionPixelOffset(R.styleable.XunDaImageView_xunda_border_width, borderWidth);
            pressAlpha = array.getInteger(R.styleable.XunDaImageView_xunda_press_alpha, pressAlpha);
            pressColor = array.getColor(R.styleable.XunDaImageView_xunda_press_color, pressColor);
            radius = array.getDimensionPixelOffset(R.styleable.XunDaImageView_xunda_radius, radius);
            shapeType = array.getInteger(R.styleable.XunDaImageView_xunda_shape_type, shapeType);
            array.recycle();
        }
