 ...
 * 1个按钮的提醒提示弹出框
 */
public class ToastDialog_No_Finish extends Dialog implements
	...
	public ToastDialog_No_Finish(Context context, String title, String content, String button_text, DialogConfirmListener confirmListener) {
