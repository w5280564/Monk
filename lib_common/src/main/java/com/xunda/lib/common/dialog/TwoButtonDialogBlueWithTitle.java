 ...
 * 两个按钮蓝色按钮字体的弹出框(带标题)
 */
public class TwoButtonDialogBlueWithTitle extends Dialog implements
        View.OnClickListener {

    private ConfirmListener listener;
    private String title, content, left, right;
    private Context mContext;
    private TextView tv_title,tv_content, tv_right, tv_left;
    private Integer leftColor, rightColor;


    public TwoButtonDialogBlueWithTitle(Context context,  String title,String content, String left,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_two_button_blue_with_title
        );
