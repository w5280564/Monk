...
public class MySwitchItemView extends ConstraintLayout {
    ...
    public MySwitchItemView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MySwitchItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    public void init(Context context, AttributeSet attrs) {
        root = LayoutInflater.from(context).inflate(R.layout.my_switchitemview, this);
        ...
        titleColor = a.getColor(R.styleable.SwitchItemView_switchItemTitleColor, ContextCompat.getColor(getContext(), R.color.text_color_444444));
        if(titleColorId != -1) {
    ...
    private void setListener() {
        switchItem.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(listener != null) {
                    listener.onCheckedChanged(MySwitchItemView.this, isChecked);
                }
            }
        });
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        void onCheckedChanged(MySwitchItemView buttonView, boolean isChecked);
    }
}
