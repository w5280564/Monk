...
public class InterestDetail_All_Adapter extends BaseQuickAdapter<InterestDetailAll_Bean, BaseViewHolder> {

    public InterestDetail_All_Adapter() {
        super(R.layout.foucs_adapter);
    }


    @Override
    protected void convert(@NonNull BaseViewHolder helper, InterestDetailAll_Bean item) {
