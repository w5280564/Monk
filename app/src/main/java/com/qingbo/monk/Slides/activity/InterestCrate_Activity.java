 ...
 * 兴趣组话题发布页
 */
public class InterestCrate_Activity extends BaseCameraAndGalleryActivity_More implements FontStylePanel.OnFontPanelListener, RichEditText.OnSelectChangeListener{
