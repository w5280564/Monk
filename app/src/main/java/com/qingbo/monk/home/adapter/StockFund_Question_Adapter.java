...
public class StockFund_Question_Adapter extends BaseQuickAdapter<StockOrFund_QuestionBean, BaseViewHolder> {

    public StockFund_Question_Adapter() {
        super(R.layout.stockfund_mess_adapter);
    }


    @Override
    protected void convert(@NonNull BaseViewHolder helper, StockOrFund_QuestionBean item) {
        ...
        if (TextUtils.equals(is_anonymous, "1")) {
            ...
            isFollow(item.getStatus(), follow_Tv, send_Mes);
        }
