...
public class InterestMember_Adapter extends BaseQuickAdapter<InterestMember_Bean, BaseViewHolder> {

    public InterestMember_Adapter() {
        super(R.layout.articlezan_adapter);
    }


    @Override
    protected void convert(@NonNull BaseViewHolder helper, InterestMember_Bean item) {
        ...
        isFollow(item.getStatus_num(), follow_Tv, send_Mes);
        String format = String.format("关注%1$s人，粉丝%2$s人",  item.getFollowerNum(), item.getFansNum());
    ...
    public void isFollow(String follow_status, TextView follow_Tv, View send_Mes) {
        if (TextUtils.equals(follow_status, "0")|| TextUtils.equals(follow_status, "3")) {
        ...
        } else if (TextUtils.equals(follow_status, "1")) {
            follow_Tv.setVisibility(View.GONE);
            send_Mes.setVisibility(View.GONE);
        } else if (TextUtils.equals(follow_status, "2")) {
            follow_Tv.setVisibility(View.VISIBLE);
            ...
            send_Mes.setVisibility(View.GONE);
        } else if (TextUtils.equals(follow_status, "4")) {
            follow_Tv.setVisibility(View.VISIBLE);
