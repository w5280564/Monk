...
public class MyDynamic_MoreItem_Combination_Shares extends BaseQuickAdapter<MyDynamic_MoreItem_Bean.DetailDTO, BaseViewHolder> {
    public MyDynamic_MoreItem_Combination_Shares() {
        super(R.layout.item_shares);
    }

    @RequiresApi(api = Build.VERSION_CODES.M)
    @Override
    protected void convert(@NonNull BaseViewHolder helper, MyDynamic_MoreItem_Bean.DetailDTO item) {
