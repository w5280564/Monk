 ...
 * 我的收藏item
 */
public class MyCollect_Adapter extends BaseQuickAdapter<MyDynamic_Bean, BaseViewHolder> {
    boolean isExpert;

    public MyCollect_Adapter() {
        super(R.layout.item_question_list_my);
    }

    public MyCollect_Adapter(boolean isExpert) {
        super(R.layout.item_question_list_my);
    ...
    @Override
    protected void convert(@NonNull BaseViewHolder helper, MyDynamic_Bean item) {
