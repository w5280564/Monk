 ...
 * 草稿箱--社群
 */
public class MyDrafts_Group_Fragment extends BaseRecyclerViewSplitFragment {
     ...
     * @return
     */
    public static MyDrafts_Group_Fragment newInstance(String type) {
        Bundle args = new Bundle();
        args.putString("type", type);
        MyDrafts_Group_Fragment fragment = new MyDrafts_Group_Fragment();
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                switch (view.getId()) {
                    case R.id.draft_Fa:
                        ...
                        String shequnName = "";
                        PublisherGroupTopicActivity.actionStart(mActivity, item, true, shequnId, shequnName);
