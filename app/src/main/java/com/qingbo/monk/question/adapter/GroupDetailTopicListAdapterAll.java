...
import com.qingbo.monk.bean.GroupTopicBean;
 ...
 * 社群话题全部列表
 */
public class GroupDetailTopicListAdapterAll extends BaseQuickAdapter<GroupTopicBean, BaseViewHolder> {

    public GroupDetailTopicListAdapterAll() {
        super(R.layout.item_group_detail_all);
    }


    @Override
    protected void convert(@NonNull BaseViewHolder helper, GroupTopicBean item) {
