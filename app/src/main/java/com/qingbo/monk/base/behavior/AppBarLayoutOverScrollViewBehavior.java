package com.qingbo.monk.base.behavior;
...
import com.qingbo.monk.base.baseview.DisInterceptNestedScrollView;
...
//                mToolBar.setAlpha((float) Math.abs(i) / (float) appBarLayout.getTotalScrollRange());
            }
        });
        return handled;
    }
