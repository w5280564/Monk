...
import com.flyco.banner.widget.Banner.base.BaseBannerFuKun;

import java.util.ArrayList;

public abstract class BaseIndicatorBannerFuKun<E, T extends BaseIndicatorBannerFuKun<E, T>> extends BaseBannerFuKun<E, T> {
    ...
    public BaseIndicatorBannerFuKun(Context context) {
        this(context, null, 0);
    }

    public BaseIndicatorBannerFuKun(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BaseIndicatorBannerFuKun(Context context, AttributeSet attrs, int defStyle) {
